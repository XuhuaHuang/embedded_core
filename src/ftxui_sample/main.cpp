...
// configuration step. It creates a namespace called `embedded_core`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", embedded_core::cmake::project_name, embedded_core::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", embedded_core::cmake::project_version);
      return EXIT_SUCCESS;
    }
